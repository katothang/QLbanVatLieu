...
namespace QuanLyVatLieu.GUI.DANHMUC
{
	public partial class NhanVien : Form
	{
		...
		private void Gvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
				...
				if (bool.Parse(gvdata.SelectedRows[0].Cells["gioitinh"].Value.ToString()))
					cbbGioiTinh.SelectedIndex = 0;
				else
					cbbGioiTinh.SelectedIndex = 1;
		}
		...
		private void PcSave_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				nhanvienDAO.Instance.themDL(tbTenTK.Text, tbMK1.Text, tbTenNV.Text, cbbChucVu.Text, dtNgaySinh.Value, tbSDT.Text, tbDiaChi.Text, gt);
		...
		private void PcEdit_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				nhanvienDAO.Instance.Sua(tbTenTK.Text, tbMK1.Text, tbTenNV.Text, cbbChucVu.Text, dtNgaySinh.Value, tbSDT.Text, tbDiaChi.Text, gt);
